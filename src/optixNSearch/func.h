...
void fillByValue(thrust::device_ptr<double>, uint64_t, double);
double reduce(thrust::device_ptr<double>, uint64_t);
...
double bruteForceSearch(float3 *, float3 *, const double, const int, const int, const int);
